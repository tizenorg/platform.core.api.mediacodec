...
#define TIZEN_ERROR_MEDIACODEC 0 //is a temporary value to avoid build error until tizen.h is updated
...
#if 0    //is blocked temporary to avoid build error until tizen.h is updated
    MEDIACODEC_ERROR_NOT_SUPPORTED_ON_DEVICE    = TIZEN_ERROR_NOT_SUPPORTED,            /**< Not supported */
#else
	MEDIACODEC_ERROR_NOT_SUPPORTED_ON_DEVICE	= TIZEN_ERROR_NONE,			/**< Not supported */
#endif
