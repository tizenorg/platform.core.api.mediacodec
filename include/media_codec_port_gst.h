...
struct _mc_gst_core_t
{
    ...
    void *module;
	int (*mc_calculate_size)();
	void* (*mc_get_tbm_surface)(MMVideoBuffer *mm_vbuffer);
	void* (*mc_get_mm_video_buffer)(media_packet_h pkt);
	int (*mc_set_parameter)(void *obj, char* sz, int value);
