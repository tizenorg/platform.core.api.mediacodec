...
int mediacodec_get_packet_pool(mediacodec_h mediacodec,media_format_h fmt,media_packet_pool_h *pkt_pool)
{

	MEDIACODEC_INSTANCE_CHECK(mediacodec);
	mediacodec_s *handle = (mediacodec_s *)mediacodec;
	int ret = mc_get_packet_pool(handle->mc_handle,fmt,pkt_pool);
